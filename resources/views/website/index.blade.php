            ...
            <table id="websites" class="table table-bordered table-striped">
                ...
                @foreach($websites as $website)
                    <tr class="">
                        ...
                        <td class="text-center col-xs-1">
                            <a href="{{ route('management-interface.website.read', $website->present()->urlArguments) }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                            ...
                            <a href="{{ route('management-interface.website.delete', $website->present()->urlArguments) }}" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
